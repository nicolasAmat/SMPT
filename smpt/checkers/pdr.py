...
class PDR(AbstractChecker):
    ...
    def __init__(self, ptnet, formula, ptnet_reduced=None, system=None, state_equation=False, debug=False,  check_proof=False, path_proof=None, method='REACH', saturation=False, unsat_core=True, solver_pids=None, solver_pids_bis=None):
        ...
        self.solver_pids_bis =  solver_pids_bis
        self.solver = None
    ...
    def prove(self, result, concurrent_pids):
        ...
        """
        info("[PDR] RUNNING")
        self.solver = Z3(debug=self.debug, strong_memory_limit=True, solver_pids=self.solver_pids, solver_pids_bis=self.solver_pids_bis)
